        ...
        <div>
            ...
            <div className="language-selector">
                ...
                <div className="dropdown-content">
                    <a href="/colles">es</a>
                    <a href="/TECNOCAMPUS/5_CINQUE/z_Varis/Storymakers/storymakers/storymakers/src/app/en/Page">en</a>
                </div>
            </div>
                ...
                <div className="banner-container bg-[url('../../public/orange-reel.png')]">
                    <div className="flip-card">
                        <div className="flip-card-inner">
                            ...
                            <div className="flip-card-back bg-[url('../../public/tedx2024-challenge-rewards.png')]"></div>
                        </div>
                    </div>
                    <div className="flip-card">
                        <div className="flip-card-inner">
